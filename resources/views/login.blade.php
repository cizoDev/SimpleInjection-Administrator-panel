...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title> Simple Injection | Admin login</title>
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="forget-form" id="forgot-password" method="post">
                 @csrf
                <h3 class="font-green">Forget Password ?</h3>
                <p> Enter your e-mail address below to reset your password. </p>
                <div class="form-group">
                    <input class="form-control placeholder-no-fix" type="email" autocomplete="off" placeholder="Email" name="email_fp" /> </div>
                <div class="form-actions">
        ...
        <div class="copyright"> {{date('Y')}} © Simple Injection. </div>
